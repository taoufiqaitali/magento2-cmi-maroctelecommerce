...
namespace cmi\cmiecom\Controller;
...
abstract class Index extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
/**
     * @inheritDoc
     */
    ...
    public function setHelper(\cmi\cmiecom\Helper\Data $helper)
    {
        $this->helper = $helper;
    }
    ...
    public function __construct(
        ...
        $params[StoreManager::PARAM_RUN_CODE] = 'default';
        $params[StoreManager::PARAM_RUN_TYPE] = 'store';
        $object_manager = $object_factory->create($params);
        $this->setHelper($object_manager->create('cmi\cmiecom\Helper\Data'));
        $this->setUtilities($object_manager->create('cmi\cmiecom\Helper\Utilities'));
